...
async function createResume(req, res) {
    try {
        ...
        // Call service
        const resume = await (0, resume_service_1.createResumeService)(userId, payload);
...
async function getResume(req, res) {
    try {
        ...
        // Call service
        const resume = await (0, resume_service_1.getResumeService)(userId);
        // Handle not found
        if (!resume) {
...
async function updateResume(req, res) {
    try {
        ...
        // Call service
        const resume = await (0, resume_service_1.updateResumeService)(userId, payload);
        return res.status(200).json({
            success: true,
...
async function deleteResume(req, res) {
    try {
        ...
        // Call service
        await (0, resume_service_1.deleteResumeService)(userId);
        return res.status(200).json({
            success: true,
